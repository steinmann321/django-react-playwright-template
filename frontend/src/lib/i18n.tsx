...
const translations: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    'nav.health': 'Health',
    'health.title': 'Health',
    'health.desc': 'Checks API status and displays example notice from backend.',
  ...
  es: {
    ...
    'nav.health': 'Salud',
    'health.title': 'Salud',
    'health.desc': 'Comprueba el estado de la API y muestra un aviso del backend.',
